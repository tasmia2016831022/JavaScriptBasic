...
class Street extends TownElement{
    ...
    classifyStreet(){
        ...
        console.log(`${this.name}, built in ${this.buildYear}, is a ${classfication.get(this.size)} street`);
    }
}

const allPrks = [new Park('Park One', 1995, 0.2, 100),
                 new Park('Park Two', 1997, 0.4, 200),
                  new Park('Park Three', 1993, 0.8, 1203),];

const allStreets = [new Street('Street One', 1996, 1.1, 2),
...
function reportStreets(s){
    ...
    console.log(`Our ${s.length} streets have a total length of ${totalLength}, and avg length of ${avgLength}. `);
